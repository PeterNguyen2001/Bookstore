    ...
    <div className="flex flex-col max-w-screen-xl mx-auto justify-center items-center">
      <div className="grid md:grid-cols-12 md:gap-20">
        <div className="col-span-5">
          <img src="https://kenhphimtv.com/wp-content/uploads/2020/07/41146-bong-ma-anh-quoc-phan-5.jpg" className="w-full" />
        ...
        <div className="col-span-7 space-y-7 pt-16">
          <h1 className="md:text-3xl text-2xl text-gray-700 font-bold">PEAKY BLINDERS</h1>
         ...
         <div>
          ...
          <p className="text-gray-400">yeah yeah</p>
         </div>
          <div className="flex flex-row space-x-5">
            ...
            <button className="border-2 bg-gray-800 text-white text-xs px-7 py-2 hover:bg-white hover:text-black transition-all duration-200">ADD TO CART</button>
          </div>
